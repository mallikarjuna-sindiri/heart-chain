        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/orphanages" className="btn bg-white text-primary-600 hover:bg-gray-100 px-8 py-3 text-lg">
                Find an Orphanage
              </Link>
              ...
              {(() => {
                ...
                if (isAuthenticated && user) {
                  ...
                  return (
                    <Link to={dashboardPath} className="btn border-2 border-white text-white hover:bg-white hover:text-primary-600 px-8 py-3 text-lg">
                      Go to Dashboard
                    </Link>
                  )
                }
